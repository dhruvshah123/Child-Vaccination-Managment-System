...
<body>
    ...
    <div class="review">
        <div class="rev-container">
            ...
            <div class="rev-card">
                <div class="identity">
                    <img src="assests\syringe.png"><a href="booking.php"><p>Vaccine Details</p></a>
                </div>  
            </div>
            
			<div class="rev-card">
                <div class="identity">
                    <img src="assests\children.png"><a href="enterchild.php"><p>Enter Children Details</p></a>
                </div>
                
            </div>
            <div class="rev-card">
                <div class="identity">
                    <img src="assests\children.png"><a href="viewchild.php"><p>View Children Details</p></a>
